  ...
  module SDK
    module Metrics
      module State
        ...
        # public API.
        class MetricStream
          # Aggregation is specified separately because it could
          # come from the metric_reader - or - the view (when we
          # actually implement views, that is).
          def initialize(instrument, aggregation, metric_reader)
